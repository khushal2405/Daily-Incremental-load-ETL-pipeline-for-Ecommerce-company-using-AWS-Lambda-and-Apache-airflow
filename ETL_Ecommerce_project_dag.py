...
s3_client = boto3.client('s3',region_name = 'ap-south-1',aws_access_key_id='xxxxxxxxxxxxxxxxxxx', aws_secret_access_key='xxxxxxxxxx')
...
def upload_file(file_name, bucket, object_name=None):
    ...
    # Upload the file
    s3_client = boto3.client('s3',region_name = 'ap-south-1',aws_access_key_id='xxxxxxxxxxxxxx', aws_secret_access_key='xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx')
    try:
